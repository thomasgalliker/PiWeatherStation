                    ...
                    var outdoorTempStackLayout = new RenderActions.StackLayout
                    {
                        ...
                        Children = new List<IRenderAction>
                        {
                                new RenderActions.Text
                                {
                                    ...
                                    VerticalTextAlignment = VerticalAlignment.Center,
                                    VerticalAlignment = VerticalAlignment.Center,
                                    Value = MeteoFormatter.FormatTemperature(currentWeather.Temperature.Value),
                                    ForegroundColor = "#000000",
                                    BackgroundColor = "#FFFFFF",
                                    FontSize = 70,
                                    AdjustsFontSizeToFitWidth = true,
                            ...
                            var indoorTempStackLayout = new RenderActions.StackLayout
                            {
                                ...
                                Children = new List<IRenderAction>
                                {
                                        ...
                                        new RenderActions.Text
                                        {
                                            ...
                                            HorizontalTextAlignment = HorizontalAlignment.Left,
                                            VerticalTextAlignment = VerticalAlignment.Top,
                                            Value = $"{MeteoFormatter.FormatTemperature(localTemperature.Value, decimalPlaces: 1)}{localTemperature:A}",
                                            ForegroundColor = "#000000",
                                            BackgroundColor = "#FFFFFF",
                                            FontSize = 20,
                                            Bold = true,
                    ...
                    for (var i = 0; i < dailyForecasts.Count; i++)
                    {
                        ...
                        var dailyWeatherRenderActions = new List<IRenderAction>
                        {
                                ...
                                new RenderActions.Text
                                {
                                    ...
                                    HorizontalTextAlignment = HorizontalAlignment.Center,
                                    VerticalTextAlignment = VerticalAlignment.Top,
                                    Value = $"{MeteoFormatter.FormatTemperature(dailyWeatherForecast.Temperature.Min.Value)}/{MeteoFormatter.FormatTemperature(dailyWeatherForecast.Temperature.Max.Value)} {dailyWeatherForecast.Temperature.Max:A}",
                                    ForegroundColor = "#000000",
                                    BackgroundColor = "#FFFFFF",
                                    FontSize = 20,
                                    Bold= false,
