                    ...
                    for (var i = 0; i < dailyForecasts.Count; i++)
                    {
                        ...
                        var dailyWeatherRenderActions = new List<IRenderAction>
                        {
                                ...
                                new RenderActions.Text
                                {
                                    ...
                                    HorizontalTextAlignment = HorizontalAlignment.Center,
                                    VerticalTextAlignment = VerticalAlignment.Top,
                                    Value = $"{MeteoFormatter.FormatTemperature(dailyWeatherForecast.TemperatureMin.Value)}/{MeteoFormatter.FormatTemperature(dailyWeatherForecast.TemperatureMax.Value)} {dailyWeatherForecast.TemperatureMax:A}",
                                    ForegroundColor = "#000000",
                                    BackgroundColor = "#FFFFFF",
                                    FontSize = 20,
                                    Bold= false,
